...
class NGFT_weighted(BaseMethod):
    ...
    def run(self):
        ...
        a_or_value = evaluate_embedding_accuracy(self.net, self.test_retain_loader_img, opt.device)/100
        print(a_or_value)
        
        a_or_value = evaluate_embedding_accuracy(self.net.fc, self.test_retain_loader, opt.device)/100
        print(a_or_value)
        ...
        for epoch in tqdm(range(self.epochs)):
            ...
            with torch.no_grad():
                ...
                acc_test_val_ret = evaluate_embedding_accuracy(self.net, self.test_retain_loader_img, opt.device)/100
                acc_test_val_fgt = evaluate_embedding_accuracy(self.net, self.test_fgt_loader_img, opt.device)/100
                acc_full_val_ret = evaluate_embedding_accuracy(self.net.fc, self.retainfull_loader_real, opt.device)/100
                acc_full_val_fgt = evaluate_embedding_accuracy(self.net.fc, self.forgetfull_loader_real, opt.device)/100
