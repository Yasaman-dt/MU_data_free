...
smiling_idx = 34  # Index for "Smiling" label in CelebA
...
for epoch in range(num_epochs):
    ...
    for inputs, full_labels in train_loader:
        ...
        smiling_labels = full_labels[:, smiling_idx]  # Smiling label (index 34)
        gender_labels = full_labels[:, 20]  # Gender label (index 20: 0 for Male, 1 for Female)
