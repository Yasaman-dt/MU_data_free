...
#
#DIR = "/projets/Zdehghani/data_free_mu_scrub"
...
#
##checkpoint_path_model = f"{DIR}/{files}/{dataset_name}/best_checkpoint_resnet18.pth"  # Set your actual checkpoint path
#model = get_model(model_name, dataset_name, num_classes, checkpoint_path=checkpoint_path) 
#    
#    
## Load the saved matrix_B_224
#matrix_B_224 = f"{DIR}/{files}/{dataset_name}/matrix_B_224.npy"
#
...
#
#train_path = f"{DIR}/{embeddings_folder}/{dataset_name}/resnet18_train.npz"
#test_path = f"{DIR}/{embeddings_folder}/{dataset_name}/resnet18_test.npz"
#
