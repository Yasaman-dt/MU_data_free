...
sources = [
    ...
    ("results_head_ViT/results_synth_laplace", "synth"),
    ("results_head_ViT/results_synth_uniform", "synth"),
]
...
if all_data:
    ...
    final_df.to_csv(os.path.join(parent_dir, "results_head_ViT/results_diff_sampling/results_unlearning.csv"), index=False)
    ...
    # Save results
    best_df.to_csv(os.path.join(parent_dir, "results_head_ViT/results_diff_sampling/results_unlearning_best_per_model_by_aus.csv"), index=False)
    ...
    save_dir = os.path.join(parent_dir, "results_head_ViT/results_diff_sampling/best_per_dataset_method_source")
    ...
    stats_path = os.path.join(parent_dir, "results_head_ViT/results_diff_sampling/results_mean_std_all_numeric.csv")
